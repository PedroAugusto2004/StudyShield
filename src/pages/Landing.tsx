    ...
    <div className="min-h-screen bg-white overflow-x-hidden" style={{ scrollBehavior: 'smooth' }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <a href="https://ai.google/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:bg-white/80 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.3)] transition-all duration-300 cursor-pointer">
              ...
              <span className="text-sm font-medium text-gray-700">{t('powered.by.google.ai.technology')}</span>
            </a>
          </motion.div>
        </div>
      </motion.section>
